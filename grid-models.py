...
et_grid_params = {
	"max_features": [1,2,3,4,5,6,7,10,'auto'],
...
gb_grid_params = {
	"learning_rate": [0.001, 0.003, 0.01, 0.02, 0.03, 0.04, 0.07, 0.1, 0.3, 0.5],
...
svc_grid_params = {
	...
	"C": [1, 5, 7, 9, 10, 11, 13, 17, 20, 25, 30, 35, 40, 45, 50, 55, 60, 75, 100, 300, 1000],
}
